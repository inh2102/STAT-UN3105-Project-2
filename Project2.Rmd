...
```{r}
paste("Longitude:",gam_long_preds[which(errors$comb==min(errors$comb))])
paste("Latitude:",gam_lat_preds[which(errors$comb==min(errors$comb))])
paste("UNIX Time:",(86400*7)+gam_time_preds[which(errors$comb==min(errors$comb))])
...
```{r}
paste("Longitude:",gam_long_preds[which(errors$comb==sort(errors$comb)[3])])
paste("Latitude:",gam_lat_preds[which(errors$comb==sort(errors$comb)[3])])
paste("UNIX Time:",(86400*7)+gam_time_preds[which(errors$comb==sort(errors$comb)[3])])
plot(cex=0.1,df$longitude,df$latitude)
