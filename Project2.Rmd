...
- uncertainty or inaccuracies in the raw data given (the GPS giving biased estimates for longitude or latitude, giving incorrect data about times or timezones).
- the assumptions of the model this report will create, and the degree uncertainty associated with predictions. The final model will be highly imperfect, but represents a best guess.
...
summary(lm(data=time,speed~temperature))
```
